                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="event_btn_inner">
                            <a class="event_btn" href="event.php"><i class="fa fa-table" aria-hidden="true"></i>Book a Table</a>
                            <a class="event_btn" href="table.php"><i class="fa fa-calendar" aria-hidden="true"></i>Book an Event</a>
                        </div>
                    </div>
                    <div class="col-md-4">
        ...
        <section class="banner_area">
            <div class="container">
                <div class="banner_content">
                    ...
                    <a class="active" href="blog.php">List</a>
                </div>
            </div>
        </section>
        <!--================End Banner Area =================-->
